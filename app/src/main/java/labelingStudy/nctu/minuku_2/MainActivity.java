...
//        initializeActionList();
        ...
        db = Room.databaseBuilder(getApplicationContext(),appDatabase.class,"dataCollection")
...
//        sensorDataRecords.get(0).getmAccele_str();
//        //sensorDataRecords.get(0).getmAmbientTemperature_str();
//        sensorDataRecords.get(0).getmGravity_str();
//        sensorDataRecords.get(0).getmGyroscope_str();
//        sensorDataRecords.get(0).getmLinearAcceleration_str();
//        sensorDataRecords.get(0).getmMagneticField_str();
//        sensorDataRecords.get(0).getmLight_str();
//        sensorDataRecords.get(0).getmPressure_str();
//        sensorDataRecords.get(0).getmProximity_str();
//        //sensorDataRecords.get(0).getmRelativeHumidity_str();
//        sensorDataRecords.get(0).getmRotationVector_str();
        Log.e(TAG,"start");
