    ...
    private TimerTask task = new TimerTask(){
        ...
        public void run() {
            ...
            if (startflag){
                ...
                SessionManager.sessionid = SessionManager.sessionid + ", " + String.valueOf(SessionManager.sessionid_unStatic);
...
//                        String sitename = sharedPrefs.getString("timer_sitename","");
                ...
                editor.putInt("sessionid_unStatic",SessionManager.sessionid_unStatic);
