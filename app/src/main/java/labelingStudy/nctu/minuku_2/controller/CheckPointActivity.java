    ...
    private Button.OnClickListener checkpointing = new Button.OnClickListener() {
        public void onClick(View v) {
            ...
            try{
                ...
                latitude = (float)LocationStreamGenerator.latestLatitude.get();
                longitude = (float)LocationStreamGenerator.latestLongitude.get();
                accuracy = LocationStreamGenerator.latestAccuracy;
            ...
            String sessionid = "0, "+ String.valueOf(SessionManager.sessionid_unStatic);
...
//            LocationToTrip.add(record);
            ...
            try {
                ...
                values.put(DBHelper.confirmTransportation_col, transportation);
                values.put(DBHelper.PRESSURE_col, "true");
            ...
            SessionManager.sessionid_unStatic ++;
