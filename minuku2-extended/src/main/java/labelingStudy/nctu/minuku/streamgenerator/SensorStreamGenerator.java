...
public class SensorStreamGenerator extends AndroidStreamGenerator<labelingStudy.nctu.minuku.model.DataRecord.SensorDataRecord> implements
        SensorEventListener {
    ...
    @Override
    public Stream<labelingStudy.nctu.minuku.model.DataRecord.SensorDataRecord> generateNewStream() {
        return null;
    }
    ...
    public boolean updateStream() {
        ...
        try {
            ...
            //mDAO.insertAll(sensorDataRecord);
//            mDAO.query_check();
